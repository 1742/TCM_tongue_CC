...
def resnet18(in_channels=3, num_classes=1000, include_top=True):
    # https://download.pytorch.org/models/resnet18-f37072fd.pth
    return ResNet(BasicBlock, [2, 2, 2, 2], in_channels=in_channels, num_classes=num_classes, include_top=include_top)
...
if __name__ == '__main__':
    ...
    png = torch.randint(255, (8, 3, 448, 448)).float().to(device)
    label = torch.randint(2, (8,)).to(device)
    out = model(png / 255.)
    print(out, out.size())
